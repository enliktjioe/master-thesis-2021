...
if __name__ == "__main__":
    ...
    for appCategory in appCategories:
        ...
        for fold in range(0,10):
            Test_dataset= "cv-" + appCategory.name + "/" + "combine" + str(fold) + ".tsv"
            Train_dataset= "cv-" + appCategory.name + "/" + "train" + str(fold) + ".tsv"
...
#         print("#########Token-based Evaluation (Exact and In-Train)################")
#         avg_precision_inTrain_token = np.mean(lst_precision_inTrain_Token)
#         avg_recall_inTrain_token = np.mean(lst_recall_inTrain_Token)
#         avg_fscore_inTrain_token = 2*((avg_precision_inTrain_token*avg_recall_inTrain_token)/(avg_precision_inTrain_token+avg_recall_inTrain_token))
#         print('Precision = %.3f, Recall = %.3f, FScore = %.3f'% (avg_precision_inTrain_token,avg_recall_inTrain_token,avg_fscore_inTrain_token))
#         print("")
        
#         print("#########Type-based Evaluation (Exact and In-Train)################")
#         avg_precision_inTrain_type = np.mean(lst_precision_inTrain_Type)
#         avg_recall_inTrain_type= np.mean(lst_recall_inTrain_Type)
#         avg_fscore_inTrain_type = 2*((avg_precision_inTrain_type*avg_recall_inTrain_type)/(avg_precision_inTrain_type+avg_recall_inTrain_type))
#         print('Precision = %.3f, Recall = %.3f, FScore = %.3f'% (avg_precision_inTrain_type,avg_recall_inTrain_type,avg_fscore_inTrain_type))
#         print("")
        
#         print("#########Token-based Evaluation (Exact and Out of Train)################")
#         avg_precision_OutTrain_token = np.mean(lst_precision_outTrain_Token)
#         avg_recall_OutTrain_token = np.mean(lst_recall_outTrain_Token)
#         avg_fscore_OutTrain_token = 2*((avg_precision_OutTrain_token*avg_recall_OutTrain_token)/(avg_precision_OutTrain_token+avg_recall_OutTrain_token))
#         print('Precision = %.3f, Recall = %.3f, FScore = %.3f'% (avg_precision_OutTrain_token,avg_recall_OutTrain_token,avg_fscore_OutTrain_token))
#         print("")
        
#         print("#########Type-based Evaluation (Exact and Out of Train)################")
#         avg_precision_OutTrain_type = np.mean(lst_precision_outTrain_Type)
#         avg_recall_OutTrain_type= np.mean(lst_recall_outTrain_Type)
#         avg_fscore_OutTrain_type = 2*((avg_precision_OutTrain_type*avg_recall_OutTrain_type)/(avg_precision_OutTrain_type+avg_recall_OutTrain_type))
#         print('Precision = %.3f, Recall = %.3f, FScore = %.3f'% (avg_precision_OutTrain_type,avg_recall_OutTrain_type,avg_fscore_OutTrain_type))
        print("")
