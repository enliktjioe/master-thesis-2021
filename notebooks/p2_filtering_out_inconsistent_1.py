...
# df_p1 = pd.read_csv(config['csv_input_local']['blablacar_apple_google_p1'], index_col=0)
# df_p1 = pd.read_csv(config['csv_input_local']['via_apple_google_p1'], index_col=0)
# df_p1 = pd.read_csv(config['csv_input_local']['olacabs_apple_google_p1'], index_col=0)
# df_p1 = pd.read_csv(config['csv_input_local']['freenow_apple_google_p1'], index_col=0)
...
df_p2.to_csv(config['csv_input_local']['bolt_apple_google_p2'])
# df_p2.to_csv(config['csv_input_local']['blablacar_apple_google_p2'])
# df_p2.to_csv(config['csv_input_local']['via_apple_google_p2'])
# df_p2.to_csv(config['csv_input_local']['olacabs_apple_google_p2'])
# df_p2.to_csv(config['csv_input_local']['freenow_apple_google_p2'])