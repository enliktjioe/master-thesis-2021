...
# bert_model = ktrain.load_predictor('C:/GitRepo/master-thesis-2021/notebooks/bert_model_all').model
# bert_preproc = ktrain.load_predictor('C:/GitRepo/master-thesis-2021/notebooks/bert_model_all').preproc
