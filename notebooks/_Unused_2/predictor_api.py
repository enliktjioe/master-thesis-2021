...
# bert_model = ktrain.load_predictor('bert_model_all').model
# bert_preproc = ktrain.load_predictor('bert_model_all').preproc
# bert_model = ktrain.load_predictor('bert_model_all_p2').model
# bert_preproc = ktrain.load_predictor('bert_model_all_p2').preproc
bert_model = ktrain.load_predictor('bert_model_all_p3').model
bert_preproc = ktrain.load_predictor('bert_model_all_p3').preproc
# bert_model = ktrain.load_predictor('bert_model_all_p4').model
# bert_preproc = ktrain.load_predictor('bert_model_all_p4').preproc
